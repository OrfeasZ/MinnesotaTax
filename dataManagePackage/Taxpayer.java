...
public class Taxpayer {
	...
	private double calculateTaxForMarriedFilingJointlyTaxpayerFamilyStatus(double totalIncome){
		double tax;
	...
	private double calculateTaxForMarriedFilingSeparately(double totalIncome){
		double tax;
	...
	private double calculateTaxForSingles(double totalIncome){
		double tax;
	...
	private double calculateTaxForHeadOfHousehold(double totalIncome){
		double tax;
