...
public class DataImportDialog extends JDialog {
    ...
    public DataImportDialog(String path) {
        setResizable(false);
    ...
    private void initElements() {
        JScrollPane scrollPane = GUIUtils.addScrollPane(getContentPane(), new Rectangle(10, 11, 250, 258));
        ...
        loadDataButton = GUIUtils.addButton(getContentPane(), "<html>Φόρτωση δεδομένων<br>επιλεγμένων αρχείων</html>", new Rectangle(270, 11, 198, 68));
        selectAllButton = GUIUtils.addButton(getContentPane(), "Επιλογή όλων", new Rectangle(10, 274, 250, 23));
    }
        ...
        loadDataButton.addActionListener(e -> {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Παρουσιάστικε σφάλμα κατά την ανάγνωση των αρχείων.", "Σφάλμα", JOptionPane.WARNING_MESSAGE);
                } catch (SAXException | ParserConfigurationException ex) {
                    JOptionPane.showMessageDialog(null, "Παρουσιάστικε σφάλμα κατά την αποκοδικοποίηση των αρχείων.", "Σφάλμα", JOptionPane.WARNING_MESSAGE);
                }
    ...
    private void setSelectAllHandler() {
        selectAllButton.addActionListener(e -> fileList.setSelectionInterval(0, fileList.getModel().getSize() - 1));
    }
